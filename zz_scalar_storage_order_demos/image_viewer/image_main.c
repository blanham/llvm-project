...
static int use_manual=0; static size_t bench_iter=0; static int decode_pixels=0;
...
int main(int argc,char**argv){ if(argc<2){ fprintf(stderr,"Usage: %s <image> [--manual] [--bench=ITER] [--decode]\n", argv[0]); return 1; }
